...
public class FlyAdapter extends RecyclerView.Adapter {

    private Context context;
    private ArrayList<ShiBean.DataBeanX.DataBean> list;

    public FlyAdapter(Context context, ArrayList<ShiBean.DataBeanX.DataBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_fly, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.tv_feeds_text.setText(String.valueOf(dataBean.getFeeds_text()));
        ...
        Log.e("TAG","run:"+dataBean.getUrl());

        BasisVideoController controller = new BasisVideoController(context);
        viewHolder.iv_cover.setUrl(dataBean.getUrl());
        viewHolder.iv_cover.setController(controller);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View rootView) {
            ...
            this.iv_cover = (VideoPlayer) rootView.findViewById(R.id.iv_cover);
